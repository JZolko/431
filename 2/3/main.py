...
# Red-Black Tree class taken from Dolson's github repo
...
def main():
    ...
    for test_idx in range(N):
        ...
        try:
            ...
            priority = None
        if action == 1:
            emails.append(priority)
            max_emails.insert(priority)
        elif action == 2:
            max_emails.delete(emails.pop())
        else:
            print(max_emails.maximum().item)
